...
<form action="<?php echo JRoute::_('index.php?option=com_notifications&layout=edit&id=' . (int) $this->item->id . '&extension='.$this->component); ?>"
				...
				<div class="col-12">
					<ul class="nav nav-tabs" role="tablist">
						<?php
						 ...
						 ?>
						<li class="nav-item">
							<a class="nav-link active" id="notification-tab" href="#notification" aria-controls="notification" data-toggle="tab"><?php echo JText::_('COM_NOTIFICATIONS_VIEW_NOTIFICATION_TAB_NOTIFICATION')?></a></li>
						</li>
						<li class="nav-item">
							<a class="nav-link" id="email-tab" href="#email" aria-controls="email"  data-toggle="tab"><?php echo JText::_('COM_NOTIFICATIONS_VIEW_NOTIFICATION_TAB_Email') ?></a>
						</li>
				  </ul>

				<div class="tab-content">
					<div  class="tab-pane active" id="notification" role="tabpanel" aria-labelledby="notification-tab">
					...
					<div class="tab-pane" id="email" role="tabpanel" aria-labelledby="email-tab">
						...
						<?php if ($this->tags): ?>
						<div class="col-4">
							<div class="alert alert-info"><?php echo JText::_('COM_NOTIFICATIONS_TAGS_DESC'); ?> <br/></div>
								<table class="table table-bordered">
									<thead class="thead-default">
										<tr>
											<th><?php echo JText::_('COM_NOTIFICATIONS_REPLACEMENT_TAGS'); ?></th>
											<th><?php echo JText::_('COM_NOTIFICATIONS_REPLACEMENT_TAGS_DESC'); ?></th>
										</tr>
									</thead>
									<tbody>
