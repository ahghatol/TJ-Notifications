...
/**
	...
	*/
	...
	protected function getListQuery()
	{
		...
		$query->select('*')
			->from($db->quoteName('#__notification_templates'));
	...
	protected function populateState($ordering = 'id', $direction = 'asc')
	{
		...
		$limitstart = $mainframe->getUserStateFromRequest('global.list.limitstart', 'limitstart', $mainframe->getCfg('list_limitstart'), 'int');
